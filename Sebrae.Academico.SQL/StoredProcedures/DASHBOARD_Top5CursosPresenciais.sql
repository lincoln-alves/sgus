-- Procedure usada na home para recuperar o top 5 de cursos presenciais com usuários inscritos
-- Data: 18/04/2016
-- Alterações
...
SELECT
	TOP 5 COUNT (DISTINCT mo.ID_Usuario) QuantidadeDeUsuariosInscritos,
...
AND fa.ID_FormaAquisicao <> @ID_Comunidade_Virtual -- Status inscrito 
WHERE
...
AND fa.NM_FormaAquisicao LIKE 'Curso presencial'
AND (
	@IdUf IS NULL
	OR mo.ID_UF = @IdUf
)
