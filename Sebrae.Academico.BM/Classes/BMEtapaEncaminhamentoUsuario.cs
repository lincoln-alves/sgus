...
namespace Sebrae.Academico.BM.Classes
{
    public class BMEtapaEncaminhamentoUsuario : BusinessManagerBase, IDisposable
    {
        ...
        public IList<EtapaEncaminhamentoUsuario> ObterPorIdEtapaResposta(int idEtapaResposta)
        {
            return repositorio.session.Query<EtapaEncaminhamentoUsuario>().Where(e => e.EtapaResposta.ID == idEtapaResposta).ToList();
        }
