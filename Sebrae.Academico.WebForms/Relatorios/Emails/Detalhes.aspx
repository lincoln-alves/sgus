<%@ Page Title="Relatório de Envio" Language="C#" MasterPageFile="~/Pagina.master" AutoEventWireup="true" CodeBehind="Detalhes.aspx.cs" Inherits="Sebrae.Academico.WebForms.Relatorios.Emails.Detalhes"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="dgvEmails" CssClass="table col-sm-12" AutoGenerateColumns="false" runat="server">
        <Columns>
