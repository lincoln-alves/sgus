<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina.master" AutoEventWireup="true"
    CodeBehind="Capacitados.aspx.cs" Inherits="Sebrae.Academico.WebForms.Relatorios.Capacitados.Capacitados"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <asp:Panel ID="Filtros" runat="server" ClientIDMode="Static" CssClass="panel-collapse collapse in">
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <asp:Label ID="Label5" runat="server" Text="Data Início de conclusão do curso" AssociatedControlID="txtDataInicio" />
                            <asp:TextBox ID="txtDataInicio" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:Label ID="Label6" runat="server" Text="Data fim de conclusão do curso" AssociatedControlID="txtDataFim" />
                            <asp:TextBox ID="txtDataFim" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:Label ID="Label7" runat="server" Text="Situação do Usuário" AssociatedControlID="cbxSituacaoUsuario" />
                            <asp:DropDownList ID="cbxSituacaoUsuario" runat="server" CssClass="form-control">
                            </asp:DropDownList>
                        </div>
    ...
    <asp:Label ID="lblQuantidadeEncontrada" runat="server" CssClass="form-control" Height="55px"></asp:Label>
    <br />
    <br />
    ...
    <asp:GridView ID="dgRelatorio" runat="server" AutoGenerateColumns="False" AllowSorting="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="TotalCapacitados" HeaderText="Total de Capacitados" SortExpression="TotalCapacitados" />
