<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina.master" AutoEventWireup="true"
    CodeBehind="LogAcessosPortal.aspx.cs" Inherits="Sebrae.Academico.WebForms.Relatorios.LogAcessosPortal"
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <fieldset>
                        <div class="form-group">
                            <asp:CheckBoxList ID="chkListaCamposVisiveis" runat="server" RepeatDirection="Vertical"
                                ...
                                <asp:ListItem Selected="True" Value="Pagina">Página visitada</asp:ListItem>
    ...
    <asp:Button ID="btnResetar" runat="server" Text="Reiniciar" OnClick="btnResetar_Click"
    ...
    <asp:GridView ID="dgRelatorio" runat="server" AutoGenerateColumns="False" AllowSorting="True"
        ...
        <Columns>
            <asp:BoundField DataField="Usuario.Nome" HeaderText="Nome" SortExpression="Usuario.Nome" />
            <asp:BoundField DataField="Usuario.CPF" HeaderText="Cpf" SortExpression="Usuario.CPF" />
            <asp:BoundField DataField="Usuario.UF.Nome" HeaderText="UF" SortExpression="Usuario.UF.Nome" />
            <asp:BoundField DataField="Acesso" HeaderText="Data de Acesso" SortExpression="Acesso" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" />
            <asp:BoundField DataField="Pagina" HeaderText="Página visitada" SortExpression="Pagina" />
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            ...
            $("#<%= txtDataInicial.ClientID %>").keyup(function (el) {
                var val = $(this).val();
                if (val.replace(/\/|_/g, '').length == 8) {
                    ...
                    if (date.setHours(0, 0, 0, 0) > todaysDate.setHours(0, 0, 0, 0)) {
                       $(this).val('');
                        return alert('A Data inicial não deve ser futura');
                    }
                }
            });
