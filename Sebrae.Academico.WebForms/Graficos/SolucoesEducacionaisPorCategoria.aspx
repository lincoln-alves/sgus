<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolucoesEducacionaisPorCategoria.aspx.cs"
    Inherits="Sebrae.Academico.WebForms.Graficos.SolucoesEducacionaisPorCategoria" %>
                            ...
                            (function(){
                                googleCharts.push(function drawChart() {
                                    var data = google.visualization.arrayToDataTable([
                                        ['Eixo Temático', 'Solução', 'Concluintes'],
