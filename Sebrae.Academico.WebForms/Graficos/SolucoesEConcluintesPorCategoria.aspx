<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolucoesEConcluintesPorCategoria.aspx.cs"
    Inherits="Sebrae.Academico.WebForms.Graficos.SolucoesEConcluintesPorCategoria" %>
                            ...
                            (function(){
                                googleCharts.push(function drawChart() {
                                    var data = google.visualization.arrayToDataTable([
                                        ['Eixo Temático', 'Nº de Soluções', 'Concluíntes'],
