<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MatriculasPorStatus.aspx.cs" Inherits="Sebrae.Academico.WebForms.Graficos.MatriculasPorStatus" %>
<asp:Chart ID="chartMatriculasPorStatus" 
    runat="server"
    BackColor="White"  
    Height="450px"
    Width="650px"   
    ...
    <ChartAreas>
        <asp:ChartArea Name="ChartArea1">
            ...
            <AxisY Title="Número de matrículas">
                <LabelStyle Font="Verdana, 8.25pt" />
                <MajorGrid LineColor="64, 64, 64, 64" />
            </AxisY>
        </asp:ChartArea>
