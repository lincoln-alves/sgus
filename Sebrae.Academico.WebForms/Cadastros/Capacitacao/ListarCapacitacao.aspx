<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina.master" AutoEventWireup="true"
    CodeBehind="ListarCapacitacao.aspx.cs" Inherits="Sebrae.Academico.WebForms.Cadastros.Capacitacao.ListarCapacitacao" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlCapacitacao" runat="server" Visible="false">
        ...
        <asp:GridView ID="dgvCapacitacao" runat="server" OnRowCommand="dgvCapacitacao_RowCommand" CssClass="table col-sm-12" AutoGenerateColumns="false" GridLines="None">
            <Columns>
