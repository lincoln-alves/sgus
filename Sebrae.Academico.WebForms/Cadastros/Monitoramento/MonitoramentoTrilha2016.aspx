<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina.master" AutoEventWireup="true" CodeBehind="MonitoramentoTrilha2016.aspx.cs" Inherits="Sebrae.Academico.WebForms.Cadastros.Monitoramento.MonitoramentoTrilha2016" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <fieldset>
            <div class="form-group">
                ...
                <asp:DropDownList ID="ddlTrilha" runat="server" CssClass="form-control mostrarload" AutoPostBack="true" OnSelectedIndexChanged="ddlTrilha_OnSelectedIndexChanged">
                </asp:DropDownList>
            </div>
            <div class="form-group">
                <asp:Label ID="Label2" runat="server" Text="Nível da Trilha" AssociatedControlID="ddlTrilhaNivel"></asp:Label>
                <asp:DropDownList ID="ddlTrilhaNivel" runat="server" CssClass="form-control mostrarload" AutoPostBack="true" OnSelectedIndexChanged="ddlTrilhaNivel_OnSelectedIndexChanged"></asp:DropDownList>
            </div>
            <div class="form-group">
                <asp:Label ID="Label3" runat="server" Text="Ponto Sebrae" AssociatedControlID="ddlPontoSebrae"></asp:Label>
                <asp:DropDownList ID="ddlPontoSebrae" runat="server" CssClass="form-control mostrarload" AutoPostBack="true" OnSelectedIndexChanged="ddlPontoSebrae_OnSelectedIndexChanged"></asp:DropDownList>
            </div>
            <div class="form-group">
                <asp:Label ID="Label4" runat="server" Text="Missão" AssociatedControlID="ddlMissao"></asp:Label>
                <asp:DropDownList ID="ddlMissao" runat="server" CssClass="form-control mostrarload" AutoPostBack="true" OnSelectedIndexChanged="ddlMissao_OnSelectedIndexChanged"></asp:DropDownList>
            </div>
            ...
            <div class="form-group">
                <asp:Label ID="Label15" runat="server" Text="Status" AssociatedControlID="cblStatus"></asp:Label>
        ...
        <asp:GridView ID="gvSolucoesEducacionais" runat="server" CssClass="table col-sm-12" AutoGenerateColumns="false" GridLines="None" OnRowDataBound="gvSolucoesEducacionais_RowDataBound" OnRowCommand="gvSolucoesEducacionais_RowCommand" AllowPaging="True" OnPageIndexChanging="gvSolucoesEducacionais_PageIndexChanging" PageSize="10">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Trilha">
                    <ItemTemplate>
                        <%#Eval("ItemTrilha.Missao.PontoSebrae.TrilhaNivel.Trilha.Nome")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Nível">
                    <ItemTemplate>
                        <%#Eval("ItemTrilha.Missao.PontoSebrae.TrilhaNivel.Nome")%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Ponto Sebrae">
                    <ItemTemplate>
                        <%#Eval("ItemTrilha.Missao.PontoSebrae.NomeExibicao")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label8" runat="server" Text="Loja" AssociatedControlID="txtPontoSebraeModal"></asp:Label>
                                <asp:TextBox ID="txtPontoSebraeModal" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                            </div>
                            ...
                            <div class="form-group">
                                <asp:GridView ID="gvHistoricoParticipacaoModal" runat="server" CssClass="table col-sm-12" AutoGenerateColumns="false" GridLines="None" OnRowDataBound="gvHistoricoParticipacaoModal_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Mensagem" DataField="TextoParticipacao" />
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label13" runat="server" Text="Mensagem do Guia" AssociatedControlID="txtObservacao"></asp:Label>
                            ...
                            <div class="form-group">
                                ...
                                <asp:RadioButtonList ID="rblAutorizadoModal" runat="server" CssClass="form-control" RepeatDirection="Horizontal">
                            ...
                            <div class="form-group">
                                <asp:Button ID="btnEnviarObservacao" runat="server" Text="Enviar Mensagem do Guia e Status" CssClass="btn btn-primary" OnClick="btnEnviarObservacao_OnClick" OnClientClick="return ValidarTextoObservacao();" />
                            </div>
                        </fieldset>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function ValidarTextoObservacao() {
            if (confirm('Enviar esta mensagem do guia?')) {
