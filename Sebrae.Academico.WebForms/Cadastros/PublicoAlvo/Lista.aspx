<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina.master" AutoEventWireup="true" CodeBehind="Lista.aspx.cs" Inherits="Sebrae.Academico.WebForms.Cadastros.PublicoAlvo.Lista" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <hr />
    <asp:Panel ID="pnlPublicoAlvo" runat="server" Visible="false">
        <h4>Resultado da Busca</h4>
        <asp:GridView ID="dgvPublicoAlvo" runat="server" CssClass="table col-sm-12" GridLines="None" OnRowCommand="dgvPublicoAlvo_RowCommand" OnRowDataBound="dgvPublicoAlvo_RowDataBound" AutoGenerateColumns="false" EnableModelValidation="True">
            <Columns>
                <asp:TemplateField HeaderText="Público-Alvo">
                    <ItemTemplate>
                        <%#Eval("Nome") %>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Ofertas Vinculadas">
                    <ItemTemplate>
                        <asp:Literal ID="litOfertasVinculadas" runat="server"></asp:Literal>
                    </ItemTemplate>
                </asp:TemplateField>
