<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina.master" AutoEventWireup="true"
    MaintainScrollPositionOnPostback="true" CodeBehind="ListarFornecedor.aspx.cs"
    Inherits="Sebrae.Academico.WebForms.Cadastros.ListarFornecedor" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <fieldset>
        <div class="form-group">
            <asp:Label ID="Label3" runat="server" Text="Buscar por nome" AssociatedControlID="txtNome"></asp:Label>
    ...
    <asp:Panel ID="pnlFornecedor" runat="server" Visible="false">
        ...
        <asp:GridView ID="dgvFornecedor" CssClass="table col-sm-12" GridLines="None" runat="server"
            OnRowCommand="dgvFornecedor_RowCommand" AutoGenerateColumns="false" EnableModelValidation="True">
            <Columns>
