<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucGraficoMatriculadosUF.ascx.cs"
    Inherits="Sebrae.Academico.WebForms.UserControls.ucGraficoMatriculadosUF" %>
<%@ Import Namespace="Sebrae.Academico.Dominio.Enumeracao" %>
<style>
    /*#svg-map path { fill:#4CB9FF }*/
    #svg-map text {
        fill: #fff;
    ...
    .item-lista-cor1 {
        border-left-color: #2469ae;
        fill: #2469ae;
    }

    .item-lista-cor2 {
        border-left-color: #4992dc;
    }

    .item-lista-cor3 {
        border-left-color: #6ea5dc;
    }

    .item-lista-cor4 {
        border-left-color: #92b7dc;
    }

    .item-lista-cor5 {
        border-left-color: #b7cadc;
    }
...
<asp:Panel ID="pnlAviso" ClientIDMode="Static" runat="server" Visible="false">
...
<svg id="graficoMatriculadosUF" version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" height="200px" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
    <g>
        ...
        S234.852,233.695,289.558,235.641z"
                fill="<%= CorEstado(enumUF.TO) %>">
            </path>
            <text transform="matrix(1 0 0 1 287.0137 188.3208)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.TO) %>">TO</text>
        </a>
        <a xlink:href="#bahia">
        ...
        c-0.546-1.725-5.396-6.079-0.026-7.175c-3.175,0.959-1.944-4.027,0.875-3.012C316.726,200.733,314.044,200.527,313.276,197.775z"
                fill="<%= CorEstado(enumUF.BA) %>">
            </path>
            <text transform="matrix(1 0 0 1 359.7324 210.1221)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.BA) %>">BA</text>
        </a>
        ...
        C413.545,202.212,407.055,193.721,408.561,191.735z"
                fill="<%= CorEstado(enumUF.SE) %>">
            </path>
            <path class="circle" stroke="#FFFFFF" d="M417.324,182.854c6.214,0,11.266,5.035,11.266,11.262c0,6.208-5.052,11.261-11.266,11.261
        c-6.238,0-11.258-5.053-11.258-11.261C406.063,187.89,411.084,182.854,417.324,182.854z"
                fill="<%= CorEstado(enumUF.SE) %>">
            </path>
            <text transform="matrix(1 0 0 1 408.9121 198.6689)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.SE) %>">SE</text>
        </a>
        ...
        c0.219,0.108-8.244,6.681-7.506,3.314C383.556,170.4,374.241,168.566,373.011,167.238z"
                fill="<%= CorEstado(enumUF.PE) %>">
            </path>
            <text transform="matrix(1 0 0 1 401.3984 165.8003)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.PE) %>">PE</text>
        </a>
        ...
        c-3.668-2.261-7.998-3.769-11.201-6.342C410.615,172.646,412.751,171.359,413.953,169.018z"
                fill="<%= CorEstado(enumUF.AL) %>">
            </path>
            <path class="circle" stroke="#FFFFFF" d="M436.423,168.763c6.236,0,11.258,5.054,11.258,11.278c0,6.207-5.02,11.259-11.258,11.259
        c-6.241,0-11.263-5.052-11.263-11.259C425.16,173.816,430.182,168.763,436.423,168.763z"
                fill="<%= CorEstado(enumUF.AL) %>">
            </path>
            <text transform="matrix(1 0 0 1 429.7891 183.895)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.AL) %>">AL</text>
        </a>
        ...
        c1.532-5.847-12.654,1.78-5.424-8.683c2.545-3.67-6.302-0.808-6.711,0.725C410.121,144.013,407.217,139.151,404.698,138.795z"
                fill="<%= CorEstado(enumUF.RN) %>">
            </path>
            <path class="circle" stroke="#FFFFFF" d="M430.827,107.798c6.241,0,11.261,5.039,11.261,11.261c0,6.224-5.02,11.261-11.261,11.261
        c-6.209,0-11.26-5.037-11.26-11.261C419.567,112.837,424.618,107.798,430.827,107.798z"
                fill="<%= CorEstado(enumUF.RN) %>">
            </path>
            <text transform="matrix(1 0 0 1 422.541 123.9009)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.RN) %>">RN</text>
        </a>
        <a xlink:href="#ceara">
        ...
        C373.035,102.314,374.815,105.971,372.379,104.409z"
                fill="<%= CorEstado(enumUF.CE) %>">
            </path>
            <text transform="matrix(1 0 0 1 386.8379 129.0347)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.CE) %>">CE</text>
        </a>
        <a xlink:href="#piaui">
        ...
        C328.176,198.748,327.409,180.727,320.781,185.478z"
                fill="<%= CorEstado(enumUF.PI) %>">
            </path>
            <text transform="matrix(1 0 0 1 355.127 158.1045)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.PI) %>">PI</text>
        </a>
        ...
        C290.983,125.675,290.983,128.044,288.845,127.827z"
                fill="<%= CorEstado(enumUF.MA) %>">
            </path>
            <text transform="matrix(1 0 0 1 318.2754 126.7036)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.MA) %>">MA</text>
        </a>
        <a xlink:href="#amapa">
        ...
        C221.814,36.458,223.334,38.417,225.198,39.089z"
                fill="<%= CorEstado(enumUF.AP) %>">
            </path>
            <text transform="matrix(1 0 0 1 245.9023 52.6099)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.AP) %>">AP</text>
        </a>
        <a xlink:href="#para">
        ...
        C319.302,76.912,319.74,78.76,319.139,77.664z"
                fill="<%= CorEstado(enumUF.PA) %>">
            </path>
            <text transform="matrix(1 0 0 1 232.7725 122.5137)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.PA) %>">PA</text>
        </a>
        ...
        s-12.517-52.736-20.335-54.063C115.261,36.417,111.523,25.682,113.18,24.107z"
                fill="<%= CorEstado(enumUF.RR) %>">
            </path>
            <text transform="matrix(1 0 0 1 136.2939 42.3862)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.RR) %>">RR</text>
        </a>
        ...
        c-8.601-4.381-16.61-8.981-26.088-11.05c-10.282-2.259-20.635-4.793-29.878-10.011C4.121,145.766,12.433,144.779,10.078,136.412z"
                fill="<%= CorEstado(enumUF.AM) %>">
            </path>
            <text transform="matrix(1 0 0 1 98.1406 119.0591)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.AM) %>">AM</text>
        </a>
        <a xlink:href="#acre">
        ...
        c6.299-3.41-3.107-11.9-5.216-15.679c-0.52-0.918-3.588-4.655-3.629-5.957C1.642,150.174,6.612,151.968,3.656,148.545z"
                fill="<%= CorEstado(enumUF.AC) %>">
            </path>
            <text transform="matrix(1 0 0 1 47.7017 184.9355)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.AC) %>">AC</text>
        ...
        c-0.384-6.081-1.028-1.986-3.382-1.903C94.336,180.686,85.957,181.671,83.34,180.232z"
                fill="<%= CorEstado(enumUF.RO) %>">
            </path>
            <text transform="matrix(1 0 0 1 118.1299 195.3193)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.RO) %>">RO</text>
        </a>
        ...
        C143.581,176.618,141.937,174.714,142.237,173.962z"
                fill="<%= CorEstado(enumUF.MT) %>">
            </path>
            <text class="" transform="matrix(1 0 0 1 200.0244 218.4175)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.MT) %>">MT</text>
        </a>
        ...
        c0.932-2.847,1.411-9.912,0.453-11.856c-0.165-0.331-3.52-7.232-2.547-8.108C186.306,297.688,182.334,299.415,183.198,294.536z"
                fill="<%= CorEstado(enumUF.MS) %>">
            </path>
            <text class="" transform="matrix(1 0 0 1 213.2939 306.7236)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.MS) %>">MS</text>
        </a>
        <a xlink:href="#goias">
        ...
        c-3.724-0.604,1.04-3.231,0.22-4.109c-1.89-1.916-4.382,1.756-3.588-3.012C239.602,274.627,237.055,273.038,237.768,270.519z"
                fill="<%= CorEstado(enumUF.GO) %>">
            </path>
            <text class="" transform="matrix(1 0 0 1 266.9111 254.2139)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.GO) %>">GO</text>
        </a>
        <a xlink:href="#parana">
        ...
        c-3.875-1.449-2.698-6.491-6.054-8.216C226.663,364.623,222.498,367.8,222.225,363.694z"
                fill="<%= CorEstado(enumUF.PR) %>">
            </path>
            <text class="" transform="matrix(1 0 0 1 248.4453 356.1045)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.PR) %>">PR</text>
        </a>
        ...
        C276.085,411.866,233.534,382.918,231.029,383.959z"
                fill="<%= CorEstado(enumUF.SC) %>">
            </path>
            <text class="" transform="matrix(1 0 0 1 266.9111 387.7646)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.SC) %>">SC</text>
        </a>
        ...
        c-2.3-1.999-4.793-5.479-7.737-6.68c-3.478-1.367-5.615,5.145-9.052,0.821C189.168,418.854,190.332,418.032,191.236,416.881z"
                fill="<%= CorEstado(enumUF.RS) %>">
            </path>
            <text class="" transform="matrix(1 0 0 1 231.0313 414.4658)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.RS) %>">RS</text>
        </a>
        ...
        C247.982,330.386,239.876,331.21,239.3,330.554z"
                fill="<%= CorEstado(enumUF.SP) %>">
            </path>
            <text class="" transform="matrix(1 0 0 1 280.6816 327.3193)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.SP) %>">SP</text>
        </a>
        ...
        c-4.708-0.353-5.53-1.613-9.858,0.631C262.993,300.562,262.336,299.274,262.881,297.305z"
                fill="<%= CorEstado(enumUF.MG) %>">
            </path>
            <text class="" transform="matrix(1 0 0 1 328.4063 286.4561)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.MG) %>">MG</text>
        </a>
        ...
        C336.717,337.908,333.927,342.41,332.886,337.429z"
                fill="<%= CorEstado(enumUF.RJ) %>">
            </path>
            <path class="circle" stroke="#FFFFFF" d="M355.094,318.613c6.209,0,11.263,5.021,11.263,11.259c0,6.208-5.056,11.264-11.263,11.264
        c-6.211,0-11.263-5.054-11.263-11.264C343.831,323.634,348.883,318.613,355.094,318.613z"
                fill="<%= CorEstado(enumUF.RJ) %>">
            </path>
            <text class="" transform="matrix(1 0 0 1 347.4648 334.6807)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.RJ) %>">RJ</text>
        </a>
        ...
        c-1.64-0.274-3.202-0.768-4.736-1.451C368.819,311.297,369.424,309.055,367.119,308.834z"
                fill="<%= CorEstado(enumUF.ES) %>">
            </path>
            <path class="circle" stroke="#FFFFFF" d="M381.917,284.723c6.21,0,11.261,5.055,11.261,11.262c0,6.212-5.051,11.261-11.261,11.261
        c-6.212,0-11.263-5.049-11.263-11.261C370.654,289.777,375.705,284.723,381.917,284.723z"
                fill="<%= CorEstado(enumUF.ES) %>">
            </path>
            <text class="" transform="matrix(1 0 0 1 373.3047 300.4971)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.ES) %>">ES</text>
        </a>
        ...
        C291.503,252.853,292.461,246.197,292.461,246.197z"
                fill="<%= CorEstado(enumUF.DF) %>">
            </path>
            <path class="circle" stroke="#FFFFFF" d="M300.735,238.34c6.212,0,11.26,5.035,11.26,11.258c0,6.21-5.048,11.263-11.26,11.263
        c-6.209,0-11.261-5.053-11.261-11.263C289.475,243.377,294.523,238.34,300.735,238.34z"
                fill="<%= CorEstado(enumUF.DF) %>">
            </path>
            <text class="" transform="matrix(1 0 0 1 292.4141 254.2139)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.DF) %>">DF</text>
        </a>
        ...
        C405.574,150.776,400.398,142.889,401.575,141.096z"
                fill="<%= CorEstado(enumUF.PB) %>">
            </path>
            <path class="circle" stroke="#FFFFFF" d="M433.797,133.597c6.237,0,11.26,5.051,11.26,11.261c0,6.226-5.022,11.262-11.26,11.262
        c-6.208,0-11.257-5.036-11.257-11.262C422.54,138.647,427.589,133.597,433.797,133.597z"
                fill="<%= CorEstado(enumUF.PB) %>">
            </path>
            <text class="" transform="matrix(1 0 0 1 425.2129 148.9893)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.PB) %>">PB</text>
        </a>
        <a xlink:href="#nacional">
            <path stroke="#FFFFFF" d="M128.8,248.9c18.8,0,34,15.3,34,34.4c0,18.9-15.3,34.4-34,34.4c-18.8,0-34-15.4-34-34.4
		C94.7,264.2,110,248.9,128.8,248.9z"
                fill="<%= CorEstado(enumUF.NA) %>" />
            <text class="texto-15" transform="matrix(1 0 0 1 117.0818 290.2439)" fill="#FFFFFF" title="<%= PorcentagemEstado(enumUF.NA) %>">NA</text>
        </a>
    </g>
</svg>
<div id="legenda-mapa-matriculados-uf" class="div-legenda-mapa">
    <ul class="item-com-lista">
        <li class="item-lista item-lista-cor1">81% até 100%</li>
        <li class="item-lista item-lista-cor2">61% até 80%</li>
        <li class="item-lista item-lista-cor3">41% até 60%</li>
        <li class="item-lista item-lista-cor4">21% até 40%</li>
        <li class="item-lista item-lista-cor5">0% até 20%</li>
    </ul>
</div>
<script type="text/javascript">
    // Definir a altura do mapa de acordo com o container pai.
    $(document).ready(function() {
        if ($('#pnlAviso').length) {
            $('#graficoMatriculadosUF').hide();
            $('#legenda-mapa-matriculados-uf').hide();
        }
        // Não executa as definições de altura caso o usuário esteja acessando de um browser mobile.
        if (!window.mobilecheck()) {
            var grafico = $("#graficoMatriculadosUF");
            ...
            if (grafico != undefined) {
                ...
                if (body != undefined) {
                    ...
                    if (container != undefined) {
                        grafico.height($(container).height() - 75);
                    }
                }
            }
        } else {
            $("#legenda-mapa-matriculados-uf").css("margin-top", "0");
        }
        (function ($) {
            $('svg a text').tooltip({
                'container': 'body'
            });
            $('svg a').on('mouseenter', function () {
                var obj = $(this);
                $('text', obj).tooltip('show');
            }).on('mouseleave', function () {
                var obj = $(this);
                $('text', obj).tooltip('hide');
            });
        })(jQuery);
    });
</script>